<template>
  <transition name="offer-celebration-fade" @after-leave="handleAfterLeave">
    <div v-if="visible" class="offer-celebration-overlay">
      <div class="offer-celebration-card">
        <div class="offer-celebration-title">恭喜拿下 offer！</div>
        <div class="offer-celebration-subtitle">这段时间辛苦啦</div>
      </div>
    </div>
  </transition>
</template>
